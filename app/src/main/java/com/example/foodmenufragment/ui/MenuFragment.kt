...
import com.example.foodmenufragment.data.DataSource
import com.example.foodmenufragment.R
import com.example.foodmenufragment.adapter.ItemAdapter

class MenuFragment : Fragment() {

    private lateinit var recyclerView: RecyclerView
    private var myresMenu = DataSource().loadResMenu()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById(R.id.rvResMenu)
        chooseLayout()
    ...
    private fun chooseLayout() {
        ...
        val adapter = context?.let { ItemAdapter(it.applicationContext, myresMenu) }
